    ...
    return (
        <div className="bg-slate-300 text-center  md:flex items-center justify-center md:justify-between p-2">
            <div className='flex items-center'>
                ...
                <h2 className="text-3xl font-black"><span className='text-red-600'>World</span> of <span className='text-blue-600'>Toy</span> Car</h2>
            </div>
            <div> 
                <Link className='text-2xl mr-3 font-bold bg-slate-100 hover:bg-red-400 p-2 rounded-lg' to='/'>Home</Link>
                <Link className='text-2xl mr-3 bg-slate-100 font-bold hover:bg-red-400 p-2 rounded-lg' to='/alltoy'>All Toy</Link>
                <Link className='text-2xl mr-3 bg-slate-100 font-bold hover:bg-red-400 p-2 rounded-lg' to='/mytoy'>My Toy</Link>
                <Link className='text-2xl mr-3 bg-slate-100 font-bold hover:bg-red-400 p-2 rounded-lg' to='/addtoy'>Add Toy</Link>
